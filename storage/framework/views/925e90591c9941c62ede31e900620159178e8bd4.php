...
<body>
	...
	<nav class="buttonList navbar navbar-expand-md navbar-light bg-white shadow-sm">
		...
		<a onclick="edit(<?php echo e(json_encode($data)); ?>)">Modifier/Supprimer</a>
	</nav>
...
function add(){
    ...
    const form = document.createElement('form')
        ...
        form.id="form";
        form.method="post";
        form.action ="<?php echo e(route('star.store')); ?>";
...
function onEdit(dataElement){
    ...
    const formInfos = document.createElement("form");
        ...
        formInfos.action ="<?php echo e(route('star.update')); ?>";
...
function deleteImg(id){
    var url = "<?php echo e(route('star.delete')); ?>" + "?id=" + id ;
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\wamp641\www\Laravel\laravel-app\resources\views/home.blade.php ENDPATH**/ ?>